...
HXDLIN( 278)				return true;
            			...
            			break;
            			case (int)6: {
HXLINE( 282)				 ::hscript::Expr _g = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				::String _g1 = e->_hx_getString(0);
...
HXDLIN( 284)				return this->isBlock(e1);
            			...
            			break;
            			case (int)11: {
HXLINE( 286)				 ::hscript::Expr _g = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 286)				::String _g1 = e->_hx_getString(0);
HXDLIN( 286)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 286)				return this->isBlock(e1);
            			}
            			break;
            			case (int)14: {
HXLINE( 279)				 ::hscript::CType _g = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 279)				::String _g1 = e->_hx_getString(2);
HXDLIN( 279)				::Array< ::Dynamic> _g2 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 287)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 288)				 ::hscript::CType _g = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 288)				::String _g1 = e->_hx_getString(1);
HXDLIN( 288)				 ::hscript::Expr _g2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 278)				return true;
            			...
            			break;
            			case (int)23: {
HXLINE( 278)				 ::hscript::Expr _g = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 278)				::Array< ::Dynamic> _g1 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 278)				 ::hscript::Expr _g2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 278)				return true;
            			}
            			break;
            			case (int)24: {
...
HXDLIN( 285)				return this->isBlock(e1);
            			...
            			break;
            			case (int)25: {
HXLINE( 289)				::Array< ::Dynamic> _g = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 300)					 ::hscript::Expr _g = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 300)					 ::hscript::CType _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 300)					::String _g2 = e->_hx_getString(0);
...
HXDLIN( 468)						switch((int)(_g->_hx_getIndex())){
            							case (int)10: {
HXLINE( 469)								 ::hscript::Expr _g1 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 469)								 ::hscript::Expr _g2 = _g->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 476)								return this->parseExprNext(e);
            							...
            							break;
            							case (int)11: {
HXLINE( 469)								 ::hscript::Expr _g1 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 541)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 534)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 537)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 537)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 534)				edef = ::hscript::Expr_obj::EWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)11: {
HXLINE( 535)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 535)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 535)				::String v = e->_hx_getString(0);
HXLINE( 534)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 539)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 539)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 556)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 557)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 557)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 557)				::String bop = e->_hx_getString(0);
HXDLIN( 557)				return ::hscript::Expr_obj::EBinop(bop,this->makeUnop(op,e1),e2);
            			}
            			break;
            			case (int)22: {
HXLINE( 558)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 566)		switch((int)(e->_hx_getIndex())){
            			case (int)6: {
HXLINE( 567)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 567)				 ::hscript::Expr e2 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 567)				::String op2 = e->_hx_getString(0);
...
HXLINE( 571)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            			...
            			break;
            			case (int)22: {
HXLINE( 572)				 ::hscript::Expr e4 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 572)				 ::hscript::Expr e3 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 572)				 ::hscript::Expr e2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 785)									 ::hscript::CType t = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
...
HXLINE(1592)				return this->evalPreproCond(e1);
            			...
            			break;
            			case (int)6: {
HXLINE(1595)				 ::hscript::Expr _g = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN(1595)				 ::hscript::Expr _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN(1595)				::String _hx_switch_0 = e->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1593)					 ::hscript::Expr e2 = _g;
HXDLIN(1593)					 ::hscript::Expr e1 = _g1;
...
HXLINE(1595)					 ::hscript::Expr e2 = _g;
HXDLIN(1595)					 ::hscript::Expr e1 = _g1;
