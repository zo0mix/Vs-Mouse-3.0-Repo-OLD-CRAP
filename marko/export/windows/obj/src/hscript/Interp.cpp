...
HXLINE( 146)				v = this->set(this->expr(e),f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 147)				 ::hscript::Expr index = e1->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 147)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 147)				{
...
HXLINE( 177)						l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            			...
            			break;
            			case (int)5: {
HXLINE( 178)				::String f = e1->_hx_getString(1);
HXDLIN( 178)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 178)				{
...
HXLINE( 181)					v = this->set(obj,f,v);
            			...
            			break;
            			case (int)16: {
HXLINE( 182)				 ::hscript::Expr index = e1->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 182)				 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 182)				{
...
HXLINE( 213)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 214)				::String f = e->_hx_getString(1);
HXDLIN( 214)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 222)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 223)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 223)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 349)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 350)				::String f = e->_hx_getString(1);
HXDLIN( 350)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 351)				return this->get(this->expr(e1),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 352)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 352)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 352)				::String op = e->_hx_getString(0);
...
HXLINE( 355)				return fop(e1,e2);
            			...
            			break;
            			case (int)7: {
HXLINE( 356)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 356)				bool prefix = e->_hx_getBool(1);
HXDLIN( 356)				::String op = e->_hx_getString(0);
...
HXDLIN( 373)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 375)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 375)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 381)					::String f = e1->_hx_getString(1);
HXDLIN( 381)					 ::hscript::Expr e = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 386)					return this->call(null(),this->expr(e1),args);
            			...
            			break;
            			case (int)9: {
HXLINE( 388)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 389)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 390)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 390)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 391)				this->whileLoop(econd,e1);
HXLINE( 392)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 396)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 396)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 396)				::String v = e->_hx_getString(0);
...
HXLINE( 405)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 519)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 519)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 478)						 ::hscript::Expr _g1 = _g->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)						 ::hscript::Expr _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 487)									 ::hscript::Expr eValue = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 487)									 ::hscript::Expr eKey = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 487)									{
...
HXLINE( 517)					return a;
            			...
            			break;
            			case (int)18: {
HXLINE( 528)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 528)				::String cl = e->_hx_getString(0);
...
HXLINE( 562)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 563)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 563)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 563)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 564)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 565)				 ::hscript::Expr def = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				::Array< ::Dynamic> cases = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 565)				 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 581)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 393)				 ::hscript::Expr e1 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 393)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 394)				this->doWhileLoop(econd,e1);
HXLINE( 395)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 582)				::Array< ::Dynamic> _g = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 582)				::String _g1 = e->_hx_getString(0);
